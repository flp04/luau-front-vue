        ...
        <div class="card-body">
          ...
          <div class="row g-3">
            <div class="col-md-12">
              ...
              <input class="form-control" required id="nome" v-model="fornecedor.nome" type="text">
            </div>
            <div class="col-md-6">
              <label for="contato" class="form-label fw-bold">Contato</label>
              <input v-mask="'(##) # ####-####'" class="form-control" required id="contato" v-model="fornecedor.contato" type="text">
            </div>
            <div class="col-md-6">
              ...
              <div class="input-group mb-2">
                ...
                <input class="form-control" required id="rede_social" v-model="fornecedor.rede_social" type="text">
              </div>
            </div>
            <div class="col-md-12">
              <label for="segmentos" class="form-label fw-bold">Segmentos</label>
              <vue-tags-input
                v-model="segmento"
                :tags="segmentos"
                :autocomplete-items="['Moda Masculina', 'Moda Feminina', 'Plus Size']"
                @tags-changed="newTags => segmentos = newTags"
              />
            </div>
          ...
          <div class="row">
            ...
            <div class="d-flex justify-content-end">
              <button @click="cadastrarFornecedor()" class="btn btn-primary" style="margin-right: 20px;">Salvar</button>
...
import VueTagsInput from "@sipec/vue3-tags-input"
  ...
  export default {
    ...
    methods: {
      cadastrarFornecedor() {
        this.fornecedor.contato = this.fornecedor.contato.replace(/\D/g, '')
        let payload = {
          fornecedor: this.fornecedor,
          endereco: this.endereco,
          segmentos: this.segmentos
        }
        let url = 'http://127.0.0.1:8000/api/cadastrarFornecedor'
        fetch(url, {
          method: "POST",
          headers: {
