    ...
    <main id="main" class="main" v-if="!carregando">
      <div class="pagetitle">
          ...
          <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="/fornecedores">Fornecedor</a></li>
              <li class="breadcrumb-item">{{ fornecedor.nome }}</li>
          </ol>
          </nav>
      </div><!-- End Page Title -->
      ...
      <div class="card">
        <div class="card-body">
          <div class="row">
            <div class="col-md-6">
              <h4 class="card-title">#{{ fornecedor.id }} {{ fornecedor.nome }}</h4>
            </div>
            <!-- <div class="col-md-6">
          ...
          <form>
            <div class="row g-3">
              ...
              <div class="col-md-6">
                ...
                <input type="text" disabled v-model="fornecedor.contato" class="form-control">
              </div>
              <div class="col-md-6">
                <label for="rede_social" class="form-label fw-bold">Rede Social</label>
                <input type="text" disabled v-model="fornecedor.rede_social" class="form-control">
              </div>

              <br>

            <div v-if="fornecedor.enderecos != undefined && fornecedor.enderecos.length > 0">
              <div>
              ...
              <div class="row g-3">
                <div class="col-md-8">
                  ...
                  <input type="text" disabled v-model="fornecedor.enderecos[0].logradouro" class="form-control">
                </div>
                <div class="col-md-4">
                  <label for="numero" class="form-label fw-bold">Número</label>
                  <input type="text" disabled v-model="fornecedor.enderecos[0].numero" class="form-control">
                </div>
                <div class="col-md-3">
                  <label for="complemento" class="form-label fw-bold">Complemento</label>
                  <input type="text" disabled v-model="fornecedor.enderecos[0].complemento" class="form-control">
                </div>
                <div class="col-md-3">
                  <label for="bairro" class="form-label fw-bold">Bairro</label>
                  <input type="text" disabled v-model="fornecedor.enderecos[0].bairro" class="form-control">
                </div>
                <div class="col-md-3">
                  <label for="cidade" class="form-label fw-bold">Cidade</label>
                  <input type="text" disabled v-model="fornecedor.enderecos[0].cidade" class="form-control">
                </div>
                <div class="col-md-3">
                  <label for="estado" class="form-label fw-bold">Estado</label>
                  <input type="text" disabled v-model="fornecedor.enderecos[0].estado" class="form-control">
                </div>
              </div>
              <!-- <div class="col-md-10">
...
export default {
  ...
  mounted() {
    this.pegarFornecedor()
  },
  methods: {
    pegarFornecedor() {
      let vm = this
      vm.carregando = true
      let url = `http://127.0.0.1:8000/api/fornecedor/${vm.id}`
      fetch(url, {
        method: "GET",
        headers: {
